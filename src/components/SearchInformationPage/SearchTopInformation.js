...
const SearchTopInformation = ({ product }) => {
          ...
          <Content>
            ...
            <ProductDetails>
              ...
              <Div>
                ...
                <FluidData>
                  <Fluid>{product.name}</Fluid>
                  <Fluid>{product.manufacturer || "N/A"}</Fluid>
                  <Fluid2>
                  ...
                  <Fluid>
                    {product.healthTags.map((tag, index) => (
...
export default SearchTopInformation;
